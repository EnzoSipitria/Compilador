...
public class TercetoReferencia extends Terceto {
	...
	public String getAssembler() {
        ...
        String codigo = ";referencia "+second+" Element position "+first+"\n";
        ...
        /**
         * lo siguiente esta comentado xq falta probar mas el control de indices agregado en el terceto base
         * 
         * */
...
//        	size = size*4;
//        }else size = size*2;
//        System.out.println("rows: "+rows+" Columns: "+columns+" indexStart: "+indexStart);
