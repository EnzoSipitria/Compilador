...
sentencia_ejecutable : inicio_IF {estructuras.add(numberLine.pop()+". sentencia ejecutable if\n");}
					 ...
					 | FOR '(' IDENTIFICADOR operador_asignacion expresion ';'{	assignValue((Element)$3.obj,(Element)$5.obj);
																				...
																				expresion comparador expresion {Terceto comp = new TercetoComparador((Token)$8.obj,(Element)$7.obj,(Element) $9.obj); //ANDA
																												...
																												stack.push(bFalse);} 
																												';' variable DECREMENTO ')'  bloque_sentencias  {estructuras.add(numberLine.pop()+". sentencia ejecutable for\n");
					 ...
					 | FOR  '(' IDENTIFICADOR operador_asignacion expresion ';' expresion comparador expresion ';' expresion ')' error  {UI2.addText(UI2.txtDebug,"Linea: "+numberLine.peek()+". ERROR EN SENTENCIA FOR  "+"\n"); estructuras.add(numberLine.peek()+". sentencia ejecutable for\n"); errores.add("Linea: "+numberLine.pop()+"ERROR EN SENTENCIA FOR");}
